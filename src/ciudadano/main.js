...
ciudadano.get("/ciudadano", async (req, res) => {
  try {
...
ciudadano.post("/nuevoCiudadano", async (req, res) => {
  try {
    let ciudadano = {
...
ciudadano.get("/ciudadano/:id", async (req, res) => {
  try {
...
ciudadano.put("/eliminarCiudadano", async (req, res) => {
  try {
